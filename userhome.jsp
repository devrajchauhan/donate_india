<%-- 
    Document   : userhome
    Created on : Jun 19, 2019, 8:16:36 PM
    Author     : hp
--%>
<%@page import="java.io.*"%>
...
<html>
    ...
    <body bgcolor="black"><div>
        ...
        </i></a></div> <div class="a1" style='float: top'> <%@include file="menu.html" %>
           </div>
           <div class="slider">
        ...
        <div id="edu">
                <div>
                    ...
                    <div class="a11">
                        ...
                        <p class="a13">
                            <a href="donate.jsp" class="a14">Donate Now</a>
                        </p>
...
<p style="margin-left:100px">Tragedy struck her life when her father died when she was in 1 year old. 
...
<p style="margin-left:100px">Help us continue the education of these children and take them a step closer to their dreams.</p>
	...
	<script type="text/javascript" src="engine1/script.js"></script>
            ...
            <div style='float:right'>
                ...
                <div>
                    <div class="a111">
                 <video width="755" height="640" controls autoplay style="    margin-right: 32px; margin-left:40px; float:right">
