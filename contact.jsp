<%-- 
    Document   : newjsp
    Created on : Jun 22, 2019, 8:31:36 PM
    Author     : hp
--%>
<%@page import="java.io.*"%>
...
<title>contect us</title>
 <div class="a1"> <%@include file="mainmenu.html"%></div>
       ...
       <table><tr>
           ...
           <tr><td class="a1212"  style="font-size: 40px;color:white"><h><b>CONTACT US</b></h></td></tr>
            ...
            <tr><td> <input type="text"  name="name" class="a122" required></td></tr>
                 ...
                 <tr><td> <input  name="email" type="email" class="a122"></td></tr>
                 <tr><td type="phone" class="a1313" min="1111111111" max="9999999999" required><b>Phone</b>(optional)</td></tr>
  ...
  {  
   ...
   String r=request.getParameter("phone_no");
    ...
    Class.forName("com.mysql.jdbc.Driver");
     ...
     st.executeUpdate("insert into comment(name,email,phone_no,message) values('"+q+"','"+e+"','"+r+"','"+t+"')");
